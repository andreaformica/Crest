 ...
 */
@JsonPropertyOrder({
  DataNotification.JSON_PROPERTY_MESSAGE_CLASS,
  DataNotification.JSON_PROPERTY_MESSAGE_DATE,
  DataNotification.JSON_PROPERTY_CONTENT
})
...
public class DataNotification   {
  ...
  private DataNotificationContent content;
  ...
  public DataNotification messageDate(OffsetDateTime messageDate) {
