...
| API modif for global tags | release-6.1 | api-v6.0 | java 23 |
...
```
It requires additional libraries (`redocly`) in order to generate the bundle. This should be installed separately from this project.
