...
public class RuninfoApi  {
   ...
   private RuninfoApiService delegate;
    ...
    public Response createRunInfo(@ApiParam(value = "A json string that is used to construct one or more runinfodto object: { run: xxx, ... }", required = true) @NotNull @Valid  RunInfoSetDto body,@Context SecurityContext securityContext,@Context UriInfo info)
